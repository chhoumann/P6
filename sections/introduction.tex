...
(GRUs).
However, more recently in the field of natural language processing (NLP), the transformer model[cite] has shown great potential and is able outperform the aforementioned methods.
