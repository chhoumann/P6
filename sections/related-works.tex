...
Since MLPs are feedforward algorithms the inputs are combined with an initial weight in a weight sum and then given to the activation function. 
Each of these hidden layers are then feeding their output and their internal representation of the data to the next layer in the line until we reach the output layer.\cite{bentoMultilayerPerceptronExplained2021}
